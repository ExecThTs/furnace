...
class FurnaceGUI {
  ...
  int curIns, curWave, curSample, curOctave, curOrder, playOrder, prevIns, prevSample, oldRow, editStep, editStepCoarse, soloChan, orderEditMode, orderCursor;
